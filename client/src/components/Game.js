...
let socket
const ENDPOINT = 'https://gamewizo.herokuapp.com/'
...
const Game = (props) => {
    ...
    const checkWinner = (arr, player) => {
        ...
        return arr.length === 1 ? user.username : ''
    ...
    const onCardPlayedHandler = (played_card) => {
        ...
        switch (played_card) {
            ...
            case '0R': case '1R': case '2R': case '3R': case '4R': case '5R':
            case '6R': case '7R': case '8R': case '9R': case '0G': case '1G':
            case '2G': case '3G': case '4G': case '5G': case '6G':
            case '7G': case '8G': case '9G': case '0B':
            case '1B': case '2B': case '3B': case '4B': case '5B': case '6B':
            case '7B': case '8B': case '9B': case '0Y': case '1Y':
            case '2Y': case '3Y': case '4Y': case '5Y': case '6Y': case '7Y': case '8Y': case '9Y': {
            ...
            case '_R': case '_Y': case '_G': case '_B': {
        ...
        <div className={`Game backgroundColorR backgroundColor${currentColor}`}>
            {(!roomFull) ? <>
                ...
                <div className='topInfo'>
                    <img className="unoimg" src={require('../assets/logo.png').default} />
                        ...
                        <div>
                            ...
                            {currentUser === 'Player 1' && <>
                                <div className='player2Deck' style={{ pointerEvents: 'none' }}>
                                    <p className='playerDeckText'>{user.username}</p>
                            ...
                            {currentUser === 'Player 2' && <>
                                ...
                                <div className="chatBoxWrapper" style={{ position: "sticky" }, { top: "0px" }, { left: "0px" }}>
            ...
            <br />
            <a href='/'><button className="game-button red " style={{ float: "right" }}>QUIT</button></a>
        </div>
    )
}
